  ...
  return (
    <div className="relative">
      <button
        ...
        className="w-32 px-3 py-3 border border-gray-300 focus:border-gold focus:ring-1 focus:ring-gold outline-none transition-colors flex items-center justify-between bg-white"
      >
          ...
          >
            <div className="sticky top-0 bg-white border-b border-gray-200 p-4 z-10">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 focus:border-gold focus:ring-1 focus:ring-gold outline-none"
                autoFocus
              />
            </div>
              ...
              {filteredCountries.map((country) => (
                <button
                  ...
                  className={`w-full px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors border-b border-gray-100 ${
                    country.code === value ? 'bg-gold/10' : ''
                  }`}
                >
                  <div className="flex items-center gap-3">
                    <span className="text-2xl">{country.flag}</span>
                    <div className="text-left">
                      <div className="font-medium text-charcoal">{country.name}</div>
